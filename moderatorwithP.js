...
(async function(){
    try{
        ...
        // if click causes page change => you should always wait navigation as well as click promise to rsolve
...
async function handleSingleQuestion(newTab,link){
    ...
    // popup => some changes may not be saved 
    ...
    await newTab.type("#moderator","ankrypt");
